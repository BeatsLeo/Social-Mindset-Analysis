...
const compile = require('@mapbox/node-pre-gyp/lib/util/compile.js');
const handle_gyp_opts = require('@mapbox/node-pre-gyp/lib/util/handle_gyp_opts.js');
const configure = require('@mapbox/node-pre-gyp/lib/configure.js');
