...
vows.describe('log4js layouts').addBatch({
  'colouredLayout': {
    topic: function() {
      return require('log4js/lib/layouts').colouredLayout;
    },
  ...
  'messagePassThroughLayout': {
    topic: function() {
      return require('log4js/lib/layouts').messagePassThroughLayout;
    },
  ...
  'basicLayout': {
    topic: function() {
      var layout = require('log4js/lib/layouts').basicLayout,
      event = {
        data: ['this is a test'],
        startTime: new Date(2010, 11, 5, 14, 18, 30, 45),
        categoryName: "tests",
  ...
  'patternLayout': {
    topic: function() {
      ...
      }, layout = require('log4js/lib/layouts').patternLayout
      , tokens = {
  ...
  'layout makers': {
    topic: require('log4js/lib/layouts'),
