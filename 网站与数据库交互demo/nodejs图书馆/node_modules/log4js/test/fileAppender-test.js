...
vows.describe('log4js fileAppender').addBatch({
  'adding multiple fileAppenders': {
    topic: function () {
      ...
      while (count--) {
        ...
        log4js.addAppender(require('log4js/lib/appenders/file').appender(logfile), 'default-settings');
      }
  ...
  'with default fileAppender settings': {
    topic: function() {
      ...
      log4js.clearAppenders();
      log4js.addAppender(require('log4js/lib/appenders/file').appender(testFile), 'default-settings');
  ...
  'fileAppender subcategories': {
    topic: function() {
      ...
      function addAppender(cat) {
        ...
        remove(testFile);
        log4js.addAppender(require('log4js/lib/appenders/file').appender(testFile), cat);
        return testFile;
      }
  ...
  'with a max file size and no backups': {
    topic: function() {
      ...
      log4js.clearAppenders();
      log4js.addAppender(
        require('log4js/lib/appenders/file').appender(testFile, log4js.layouts.basicLayout, 100, 0),
        'max-file-size'
      );
  ...
  'with a max file size and 2 backups': {
    topic: function() {
      ...
      log4js.clearAppenders();
      log4js.addAppender(
        require('log4js/lib/appenders/file').appender(testFile, log4js.layouts.basicLayout, 50, 2),
  ...
  'with a max file size and 2 compressed backups': {
    topic: function() {
      ...
      log4js.clearAppenders();
      log4js.addAppender(
        require('log4js/lib/appenders/file').appender(
