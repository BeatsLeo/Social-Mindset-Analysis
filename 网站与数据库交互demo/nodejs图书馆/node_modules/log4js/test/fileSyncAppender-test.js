...
vows.describe('log4js fileSyncAppender').addBatch({
  'with default fileSyncAppender settings': {
    topic: function() {
      ...
      log4js.clearAppenders();
      log4js.addAppender(
        require('log4js/lib/appenders/fileSync').appender(testFile),
        'default-settings'
      );
  ...
  'with a max file size and no backups': {
    topic: function() {
      ...
      log4js.clearAppenders();
      log4js.addAppender(
        require('log4js/lib/appenders/fileSync').appender(testFile, log4js.layouts.basicLayout, 100, 0),
        'max-file-size'
      );
  ...
  'with a max file size and 2 backups': {
    topic: function() {
      ...
      log4js.clearAppenders();
      log4js.addAppender(
        require('log4js/lib/appenders/fileSync').appender(testFile, log4js.layouts.basicLayout, 50, 2),
